...
export function AddLocationCard({ onClick }: AddLocationCardProps) {
  return (
    <button
      type="button"
      onClick={onClick}
      className="group flex min-h-[148px] flex-col items-center justify-center gap-3 rounded-[var(--radius-card)] border-2 border-dashed border-glass bg-glass-subtle p-6 backdrop-blur-xl transition-all duration-300 hover:scale-[1.02] hover:border-glass-strong hover:bg-glass hover:shadow-glass active:scale-[0.98]"
    >
